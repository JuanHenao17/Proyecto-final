...
static constexpr auto qt_meta_stringdata_ZN5JuegoE = QtMocHelpers::stringData(
    "Juego"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5JuegoE[] = {
...
Q_CONSTINIT const QMetaObject Juego::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5JuegoE.offsetsAndSizes,
    qt_meta_data_ZN5JuegoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5JuegoE_t,
        // Q_OBJECT / Q_GADGET
...
void *Juego::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5JuegoE.stringdata0))
