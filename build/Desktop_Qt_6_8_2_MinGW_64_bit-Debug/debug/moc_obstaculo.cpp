...
namespace {
struct qt_meta_tag_ZN9ObstaculoE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9ObstaculoE = QtMocHelpers::stringData(
    "Obstaculo"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9ObstaculoE[] = {
...
Q_CONSTINIT const QMetaObject Obstaculo::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9ObstaculoE.offsetsAndSizes,
    qt_meta_data_ZN9ObstaculoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9ObstaculoE_t,
        // Q_OBJECT / Q_GADGET
...
void *Obstaculo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9ObstaculoE.stringdata0))
