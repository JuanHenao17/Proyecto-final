...
namespace {
struct qt_meta_tag_ZN9PersonajeE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9PersonajeE = QtMocHelpers::stringData(
    "Personaje"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9PersonajeE[] = {
...
Q_CONSTINIT const QMetaObject Personaje::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9PersonajeE.offsetsAndSizes,
    qt_meta_data_ZN9PersonajeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9PersonajeE_t,
        // Q_OBJECT / Q_GADGET
...
void *Personaje::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9PersonajeE.stringdata0))
