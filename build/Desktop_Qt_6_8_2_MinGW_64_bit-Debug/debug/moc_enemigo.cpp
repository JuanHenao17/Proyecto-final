...
namespace {
struct qt_meta_tag_ZN7EnemigoE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7EnemigoE = QtMocHelpers::stringData(
    "Enemigo"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7EnemigoE[] = {
...
Q_CONSTINIT const QMetaObject Enemigo::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7EnemigoE.offsetsAndSizes,
    qt_meta_data_ZN7EnemigoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7EnemigoE_t,
        // Q_OBJECT / Q_GADGET
...
void *Enemigo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7EnemigoE.stringdata0))
